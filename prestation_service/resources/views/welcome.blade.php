...
<section class="h-screen items-center justify-center flex">
  <div class="m-20 flex flex-col justify-center md:w-1/2">
  ...
  <div class="">
    <img src="https://d1csarkz8obe9u.cloudfront.net/posterpreviews/plumber-business-service-logo-design-template-b6f20bc4a17dffa2d20b10d0f82395c7_screen.jpg?ts=1570513154" alt="Logo" alt="Photo Prestataire 2" class="w-full h-32 object-cover mb-2" class=""/>
  </div>
</section>
...
<!-- 
    ...
    <div class="grid grid-cols-2 gap-4 md:grid-cols-4 lg:grid-cols-4 xl:grid-cols-4 p-5">
        ...
        <a href="prestataire2.html" class="box p-4 bg-white rounded-lg text-center">
            <img src="https://d1csarkz8obe9u.cloudfront.net/posterpreviews/plumber-business-service-logo-design-template-b6f20bc4a17dffa2d20b10d0f82395c7_screen.jpg?ts=1570513154" alt="Logo" alt="Prestataire 1" class="w-24 h-24 mx-auto rounded-full mb-4" alt="Prestataire 2" class="w-24 h-24 mx-auto rounded-full mb-4">
