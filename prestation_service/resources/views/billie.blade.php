...
<body>
    <section class="h-screen items-center justify-center flex justify-around m-3">
        <section class="space-y-5">
            ...
            <div class="flex flex-col space-y-5">
                ...
                <a href="#" class="border-2 p-2 rounded-2xl w-40"> Chez Billie: Douala</a>
            </div>
 ...
 <section class="">
    <div class="p-4 bg-blue-300 rounded-lg shadow-lg text-center w-80 space-y-5">
       <img src="https://d1csarkz8obe9u.cloudfront.net/posterpreviews/plumber-business-service-logo-design-template-b6f20bc4a17dffa2d20b10d0f82395c7_screen.jpg?ts=1570513154" alt="Logo" alt="Prestataire 1" class="w-24 h-24 mx-auto rounded-full mb-4">
    ...
    <section id="prestataires" class="h-screen flex flex-col items-center justify-center space-y-5">
       ...
       <a href="/billie" class="bg-white rounded-lg shadow-lg shadow-blue-300 box p-5">
           <img src="https://d1csarkz8obe9u.cloudfront.net/posterpreviews/plumber-business-service-logo-design-template-b6f20bc4a17dffa2d20b10d0f82395c7_screen.jpg?ts=1570513154" alt="Logo" alt="Photo Prestataire 2" class="w-full h-30 object-cover mb-2" alt="Photo Prestataire 1" class="w-full h-32 object-cover mb-2">
       ...
       <a href="details_prestataire2.html" class="bg-white rounded-lg p-5 shadow-lg shadow-blue-300 box">
           <img src="https://d1csarkz8obe9u.cloudfront.net/posterpreviews/plumber-business-service-logo-design-template-b6f20bc4a17dffa2d20b10d0f82395c7_screen.jpg?ts=1570513154" alt="Logo" alt="Photo Prestataire 2" class="w-full h-30 object-cover mb-2" alt="Photo Prestataire 2" class="w-full h-32 object-cover mb-2">
       ...
       <a href="details_prestataire2.html" class="bg-white rounded-lg p-5 shadow-lg shadow-blue-300 box">
           <img src="https://d1csarkz8obe9u.cloudfront.net/posterpreviews/plumber-business-service-logo-design-template-b6f20bc4a17dffa2d20b10d0f82395c7_screen.jpg?ts=1570513154" alt="Logo" alt="Photo Prestataire 2" class="w-full h-30 object-cover mb-2" alt="Photo Prestataire 2" class="w-full h-32 object-cover mb-2">
           <div class="text-center font-bold text-lg">Butterflies</div>
           <!-- <button class="mt-2 bg-blue-500 hover:bg-blue-700 text-white font-bold py-2 px-4 rounded-full">Contact</button> -->
       </a>

       <a href="details_prestataire2.html" class="bg-white rounded-lg p-5 shadow-lg shadow-blue-300 box">
           <img src="https://d1csarkz8obe9u.cloudfront.net/posterpreviews/plumber-business-service-logo-design-template-b6f20bc4a17dffa2d20b10d0f82395c7_screen.jpg?ts=1570513154" alt="Logo" alt="Photo Prestataire 2" class="w-full h-30 object-cover mb-2">
           <div class="text-center font-bold text-lg">Poses laces frontales</div>
           <!-- <button class="mt-2 bg-blue-500 hover:bg-blue-700 text-white font-bold py-2 px-4 rounded-full">Contact</button> -->
       </a>
       </div>
    </section>
