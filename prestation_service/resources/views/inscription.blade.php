...
<section class="flex">
<a href="#" class="p-8 m-10 shadow-lg rounded-lg">   
 ...
 <h2 class="text-lg font-semibold">J'ai besoin d'un service</h2>
    ...
    <div>
        ...
        <a href="#" class="text-blue-500" id="openModal">Connexion</a>
    </div>
  ...
  <div id="prestataire-modal" class="fixed top-0 left-0 w-full h-full bg-gray-900 bg-opacity-50 flex justify-center items-center hidden">
    <div class="bg-white rounded-lg shadow-lg p-8 w-96">
        ...
        <button id="close-modal" class="absolute top-3 right-3 text-gray-400 hover:text-gray-600 focus:outline-none">&times;</button>
